...
class ClienteAdmin(AdminComercialMixin, admin.ModelAdmin):
    list_display = ("nome", "empresa", "tipo_pessoa", "cpf_cnpj", "inscricao_estadual", "telefone", "whatsapp", "cidade", "ativo")
    search_fields = ("nome", "cpf_cnpj", "inscricao_estadual", "telefone", "whatsapp", "email", "empresa__nome_fantasia")
    list_filter = ("empresa", "tipo_pessoa", "ativo", "estado", "cidade")
    readonly_fields = ("criado_em", "atualizado_em")
    fieldsets = (
        ("Identificação", {"fields": ("empresa", "nome", "tipo_pessoa", "cpf_cnpj", "inscricao_estadual", "ativo")}),
