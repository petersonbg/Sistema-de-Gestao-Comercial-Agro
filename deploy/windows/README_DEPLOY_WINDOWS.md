...
4. Se o serviço não iniciar, o próprio atalho tentará executar `run_waitress.bat` em modo oculto. Você também pode testar esse fallback manualmente:
