...
def main() -> int:
    ...
    try:
        ...
        print("ERRO: nao foi possivel conectar ao PostgreSQL com as configuracoes do .env.")
        print(f"Detalhe: {exc}")
        print("")
        ...
        print("4. Se POSTGRES_USER e POSTGRES_PASSWORD em C:\\SistemaGestaoAgro\\app\\.env estao corretos.")
        print("5. Depois de corrigir, execute novamente C:\\SistemaGestaoAgro\\app\\deploy\\windows\\install.bat como Administrador.")
        return 1
